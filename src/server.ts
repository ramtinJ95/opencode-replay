 ...
 */
export function isPathSafe(rootDir: string, targetPath: string): boolean {
...
/**
 * Create a request handler for serving static files from a directory
 * Exported for testing purposes
 */
export function createRequestHandler(rootDir: string): (req: Request) => Promise<Response> {
